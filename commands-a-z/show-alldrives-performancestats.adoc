...
summary: show allDrives performanceStats命令會傳回磁碟機效能的相關資訊。 
---
= 顯示磁碟機效能統計資料 - SANtricity CLI
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
「show allDrives performanceStats」命令會傳回磁碟機效能的相關資訊。
...
「show drive performanceStats」命令會傳回磁碟機效能統計資料、如下列範例所示：
